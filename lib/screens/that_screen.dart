                  ...
                  builder: (context, AsyncSnapshot snapshotFriendId) {
                    if (snapshotFriendId.hasData) {
                      if (snapshotFriendId.data.docs.length <= 0) {
                        ...
                        //                                                         indexAnimation * 400 < 2400 ? indexAnimation * 400 : 600,
                        //                                                         2),
                        //                                                   ),
                        //                                                 ),
                        //                                               if (isWriteUser)
                        ...
                        //                                                         height / 48,
                        //                                                     decoration:
                        //                                                         BoxDecoration(borderRadius: BorderRadius.circular(50), color: Colors.deepPurpleAccent),
                        //                                                     child: animatedText(
                        //                                                         height / 68,
                        //                                                         '1',
                        //                                                         Colors.white,
                        ...
                        //                                                     child: Padding(
                        //                                                       padding: const EdgeInsets.only(right: 10),
                        //                                                       child: animatedText(height / 68, lastMsg, Colors.white.withOpacity(.3), indexAnimation * 400 < 2400 ? indexAnimation * 400 : 600, 2),
                        //                                                     ),
                        //                                                   ),
                        //                                                 if (isWriteUser)
                        //                                                   showProgressWrite(),
